# =============================================================================
# pt_cam_rx.xdc - STAGE 4. All SIX input pairs on bank 13.
#
...
# ---- the four data lanes and the sync channel, all LVDS_25 + DIFF_TERM ------
# Pins and properties verbatim from ../pt_camera.xdc. lvds_clock_in (sensor
# 23/24) is deliberately absent: PLL mode means we never drive it.
# sensor 9/10   elem B46/B48   IO_L14{N,P}_T2_SRCC_13
...
# sensor 17/18  elem B70/B72   IO_L6{N,P}_T0_13
